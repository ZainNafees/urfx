...
const CertificateSection = () => {
  ...
  return (
    <section className="relative mx-auto w-full mt-16 max-w-[1240px] py-14 text-white md:px-8 md:py-20">
      {/* Blue Glow */}
      <div
        className="
                  ...
                  <article className="relative flex min-h-[310px] flex-col overflow-hidden bg-[linear-gradient(180deg,#1b1b1b_0%,#0f0f0f_100%)] p-5">
                    ...
                    <div className="relative z-10 mb-3 flex h-[165px] items-center justify-center">
                      <Image
                        ...
                        width={300}
                        height={300}
                        className=" object-contain drop-shadow-[0_16px_24px_rgba(0,0,0,0.45)]"
                      />
                    </div>
                    ...
                    <div className="relative z-10 mt-auto">
                     ...
                     <h3 className="text-[18px] font-semibold leading-[1.05] tracking-[-0.02em]">
                        {item.name}
                      </h3>
                  </article>
          ...
          <div key={card.id} className="group relative bg-white/[0.08] p-[1px]">
            <article className="relative flex h-full min-h-[390px] flex-col overflow-hidden bg-[linear-gradient(180deg,#1b1b1b_0%,#0f0f0f_100%)] p-6">
              ...
              <div className="relative z-10 mt-auto">
                ...
                <p className=" text-[18px] leading-6 text-gray-300">
                  {card.description}
                </p>
                <h3 className="mt-3 text-[18px] max-w-[160px] font-semibold leading-[1.03] tracking-[-0.02em]">
                  {card.name}
                </h3>
              </div>
